...
const Navbar = () => {
  ...
  const linkStyle = {
    ...
    alignItems: 'center',     // Center both vertically
                // Add a 3px gap between the SVG and text
      ...
      <div
        ...
        >
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              fill={isActive('/home') ? '#0057FF' : '#ACAEC5'} 
            >
          ...
          {!isMobile && <Link to="/home" style={linkStyle}>Explore</Link>}
        </div>
        </Link>
        ...
        >
          <Link to="/clubs">
            <svg
              ...
              height="calc(100vh * 65/1512)"
              viewBox="0 0 24 24"
              fill={isActive('/clubs') ? '#0057FF' : '#ACAEC5'}
            >
        ...
        >
          <Link to="/messages">
            <svg
              ...
              height="calc(100vh * 65/1512)"
              viewBox="0 0 24 24"
              fill={isActive('/messages') ? '#0057FF' : '#ACAEC5'}
            >
        ...
        >
          <Link to="/saved-posts" >
            <svg
              ...
              height="calc(100vh * 65/1512)"
              viewBox="0 0 24 24"
              fill={isActive('/saved-posts') ? '#0057FF' : '#ACAEC5'}
            >
        ...
        >
          <Link to="/profile-settings" >
            <svg
              ...
              height="calc(100vh * 65/1512)"
              viewBox="0 0 24 24"
              fill={isActive('/profile-settings') ? '#0057FF' : '#ACAEC5'}
            >
