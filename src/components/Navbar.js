        ...
        <div style={navbarItemStyle}>
          <Link to="/">
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              fill={isActive('/home') ? '#485FF7' : '#ACAEC5'} // Apply dynamic fill color
            >
        ...
        <div style={navbarItemStyle}>
          <Link to="/clubs">
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              fill={isActive('/clubs') ? '#485FF7' : '#ACAEC5'}
            >
        ...
        <div style={navbarItemStyle}>
          <Link to="/messages">
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              fill={isActive('/messages') ? '#485FF7' : '#ACAEC5'}
            >
        ...
        <div style={navbarItemStyle}>
          <Link to="/saved-posts">
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              fill={isActive('/saved-posts') ? '#485FF7' : '#ACAEC5'}
            >
        ...
        <div style={navbarItemStyle}>
          <Link to="/profile-settings">
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              fill={isActive('/profile-settings') ? '#485FF7' : '#ACAEC5'}
            >
